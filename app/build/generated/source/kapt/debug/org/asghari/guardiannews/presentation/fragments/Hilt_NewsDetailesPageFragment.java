 ...
 */
public abstract class Hilt_NewsDetailesPageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsDetailesPageFragment() {
    super();
  }

  Hilt_NewsDetailesPageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsDetailesPageFragment_GeneratedInjector) this.generatedComponent()).injectNewsDetailesPageFragment(UnsafeCasts.<NewsDetailesPageFragment>unsafeCast(this));
    }
  }
