...
public class NewsListItemBindingImpl extends NewsListItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.News == variableId) {
            setNews((org.asghari.guardiannews.data.models.news.NewsList) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setNews(@Nullable org.asghari.guardiannews.data.models.news.NewsList News) {
        this.mNews = News;
    }
