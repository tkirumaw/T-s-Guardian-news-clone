    ...
    when (dataState) {
        ...
        is NewsListState.Success -> {
            ...
            Column(
                ...
                Text(
                    text = news.webTitle, color = MaterialTheme.colors.onSecondary,
                ...
                Text(
                    text = news.webPublicationDate, color = MaterialTheme.colors.onSecondary,
                ...
                HtmlText(
                    text =  news.fields.body , color = MaterialTheme.colors.onSecondary,
                    modifier = Modifier.padding(horizontal = 10.dp),
